...
typedef boost::bimap<string, int32_t> LookupTable;
...
namespace Nsb
{
    ...
    template <> LookupTable ConstantHolder<PhoneMail>::Constants = boost::assign::list_of<LookupTable::value_type>
        ("FM_From_XXX0001", 0)
        ("FM_From_XXX0002", 1)
        ("FM_To_DAR0001_0", 2)
        ("FM_To_DAR0001_1", 3)
    ...
    template <> LookupTable ConstantHolder<ePhoneMode>::Constants = boost::assign::list_of<LookupTable::value_type>
    ...
    template <> LookupTable ConstantHolder<PhID>::Constants = boost::assign::list_of<LookupTable::value_type>
        ("PhID_MAY", PHID_MAY)
        ("PhID_DAR", PHID_DAR)
        ("PhID_RUK", PHID_RUK)
        ("PhID_Oven", PHID_OVEN)
    ...
    template <> LookupTable ConstantHolder<Null>::Constants = boost::assign::list_of<LookupTable::value_type>
        ("null", NSB_NULL);

    template <> LookupTable ConstantHolder<Boolean>::Constants = boost::assign::list_of<LookupTable::value_type>
        ("true", NSB_TRUE)
        ("false", NSB_FALSE);

    template <> LookupTable ConstantHolder<Request>::Constants = boost::assign::list_of<LookupTable::value_type>
        ("Stop", STOP)
        ("Play", PLAY)
        ("Disused", DISUSED)
    ...
    template <> LookupTable ConstantHolder<Tempo>::Constants = boost::assign::list_of<LookupTable::value_type>
        ("Axl1", AXL_1)
        ("Axl2", AXL_2)
        ("Axl3", AXL_3)
        ("Dxl1", DXL_1)
    ...
    template <> LookupTable ConstantHolder<Shade>::Constants = boost::assign::list_of<LookupTable::value_type>
    ...
    template <> LookupTable ConstantHolder<Color>::Constants = boost::assign::list_of<LookupTable::value_type>
        ("black", BLACK)
        ("white", WHITE)
        ("blue", BLUE)
        ("red", RED)
    ...
    template <> LookupTable ConstantHolder<Tone>::Constants = boost::assign::list_of<LookupTable::value_type>
        ("NegaPosi", NEGA_POSI)
        ("Monochrome", MONOCHROME)
        ("Sepia", SEPIA)
        ("KitanoBlue", KITANO_BLUE);

    template <> LookupTable ConstantHolder<Effect>::Constants = boost::assign::list_of<LookupTable::value_type>
