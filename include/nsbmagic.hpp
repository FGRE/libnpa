...
enum /* Magic */ : uint16_t
{
    ...
    MAGIC_MULTIPLY = SWAP_UINT16(0xA700),
    ...
    MAGIC_BREAK = SWAP_UINT16(0x9D00),
    ...
    MAGIC_LOGICAL_GREATER_EQUAL = SWAP_UINT16(0xC300),
    ...
    MAGIC_LOGICAL_GREATER = SWAP_UINT16(0xC500),
    MAGIC_LOOP_JUMP = SWAP_UINT16(0xDF00), // TODO: After end of while body. No code required?
    ...
    MAGIC_CREATE_SCROLLBAR = SWAP_UINT16(0x1800),
    ...
    MAGIC_UNK85 = SWAP_UINT16(0x9A00), // switch
    MAGIC_CALL_CHAPTER = SWAP_UINT16(0xA200),
    MAGIC_UNK87 = SWAP_UINT16(0x9B00), // case
    MAGIC_UNK88 = SWAP_UINT16(0xDD00), // break
    ...
    MAGIC_EXIST_SAVE = SWAP_UINT16(0x5200),
