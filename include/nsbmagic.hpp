...
enum /* Magic */ : uint16_t
{
    ...
    MAGIC_UNK79 = SWAP_UINT16(0x3500), // maybe scrollbar related
    MAGIC_UNK80 = SWAP_UINT16(0x1C01), // maybe scrollbar related
    ...
    MAGIC_UNK184 = SWAP_UINT16(0x6600), // EnableBacklog? (returns bool, no args)
