...
enum /* Magic */ : uint16_t
{
    ...
    MAGIC_LOCK_VIDEO = SWAP_UINT16(0x7A00), // FMDM, Steins;Gate
    MAGIC_LOAD_FONT = SWAP_UINT16(0x1C00), // Chaos;Head, Steins;Gate
    MAGIC_LOAD_IMAGE = SWAP_UINT16(0x1900), // Chaos;Head, Steins;Gate
    ...
    MAGIC_SET_SHORTCUT = SWAP_UINT16(0x5800), // FMDM, Steins;Gate
    MAGIC_SAVE = SWAP_UINT16(0x4F00), // FMDM, Chaos;Head, Steins;Gate
    MAGIC_DELETE_SAVE_FILE = SWAP_UINT16(0x5100), // FMDM, Steins;Gate
    ...
    MAGIC_MOVIE_PLAY = SWAP_UINT16(0x4B00), // FMDM, Chaos;Head, Steins;Gate
    ...
    MAGIC_CREATE_STENCIL = SWAP_UINT16(0x0600), // FMDM, Steins;Gate
    ...
    MAGIC_CONQUEST = SWAP_UINT16(0x7000), // FMDM, Steins;Gate
    ...
    MAGIC_WAIT_TEXT = SWAP_UINT16(0x4200), // FMDM, Chaos;Head, Steins;Gate
    ...
    MAGIC_WAIT_FADE = SWAP_UINT16(0x3C00), // GCLX, FMDM, Chaos;Head, Steins;Gate
    MAGIC_UNK171 = SWAP_UINT16(0x5300),
    MAGIC_SOUND_AMPLITUDE = SWAP_UINT16(0x6F00), // GCLX, Chaos;Head, Steins;Gate
    MAGIC_READ_FILE = SWAP_UINT16(0x6700), // Chaos;Head
    MAGIC_DATE_TIME = SWAP_UINT16(0x5600), // GCLX, FMDM, Chaos;Head, Steins;Gate
    MAGIC_WRITE_FILE = SWAP_UINT16(0x5700), // GCLX, FMDM, Chaos;Head, Steins;Gate
    MAGIC_LOAD = SWAP_UINT16(0x5000), // Chaos;Head
    MAGIC_MESSAGE_BOX = SWAP_UINT16(0x7100), // Steins;Gate
    ...
    MAGIC_EXIT = SWAP_UINT16(0x5A00), // Chaos;Head, Steins;Gate
